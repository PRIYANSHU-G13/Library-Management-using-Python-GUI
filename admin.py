#for accessing this file you must use mysql in which u r having one table in the database named library as 'admin' in which there should be one
#entry of the data of username and password as given in the last line of the code.
#moreover, this code accesses the email also for sending mails, u need to enter your email id and password as well
#enter your mysql password beforehand for not getting unwanted errors
#use your own image by changing image location in this code for better experience
# u need to add multiple tables in the database as it is used in this code...
# ****This code is only for reference purpose, it is verified and is working properly****
...
def start_admin(user,password):
    mail_admin='EMAIL'#you can enter your email id here
    today = date.today()
    ...
    def access_mail():
        ...
        #,command=recheck
        passs='************' #password of your email id would be here
    ...
    img = ImageTk.PhotoImage(Image.open("library_1.jpg").resize((1050, 440), Image.ANTIALIAS))
...
if __name__ == "__main__":
    start_admin('admin_username','admin_password')
