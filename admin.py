...
def adds():
    ...
    def add_stu():
        ...
        if(fname=='' or usern=="" or mail=="" or cont==None or age==None or batch=="" or course=="" or passwrd==""):
        ...
        if(cont.isnumeric() and len(cont)==10):
            pass
        else:
        ...
        try:
            ...
            add_student=(fname,usern,mail,passwrd,int(cont),int(age),int(batch),course)
...
def views():
    ...
    Name.place(relx=0.04,rely=0.2,relwidth=0.08,relheight=0.06)

    User = Label(labelFrame,text="USERNAME",bg="white",fg="black")
    User.place(relx=0.16,rely=0.2,relwidth=0.1,relheight=0.06)

    E_Mail= Label(labelFrame,text="E-MAIL",bg="white",fg="black")
    E_Mail.place(relx=0.35,rely=0.2,relwidth=0.1,relheight=0.06)

    Batch = Label(labelFrame,text="BATCH",bg="white",fg="black")
    Batch.place(relx=0.518,rely=0.2,relwidth=0.1,relheight=0.06)

    Course = Label(labelFrame,text="COURSE",bg="white",fg="black")
    Course.place(relx=0.68,rely=0.2,relwidth=0.1,relheight=0.06)

    Message = Label(labelFrame,text="MESSAGE",bg="white",fg="black")
    Message.place(relx=0.82,rely=0.2,relwidth=0.14,relheight=0.06)
...
labelFrame.place(relx=0.04,rely=0.25,relwidth=0.92,relheight=0.64)
